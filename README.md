...
- Release tags use the format `v<version>` (for example `v1.36.0.4`).
...
| --- | --- | --- |
| 1.31 | release-1.36 | 1.36.0.4 |
| 1.32 | release-1.36 | 1.36.0.4 |
| 1.33 | release-1.36 | 1.36.0.4 |
| 1.34 | release-1.36 | 1.36.0.4 |
| 1.35 | release-1.36 | 1.36.0.4 |
| 1.36 | release-1.36 | 1.36.0.4 |
