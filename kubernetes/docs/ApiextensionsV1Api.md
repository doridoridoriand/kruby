...
| [**get_api_resources_get_apis_apiextensions_k8s_io_v1**](ApiextensionsV1Api.md#get_api_resources_get_apis_apiextensions_k8s_io_v1) | **GET** /apis/apiextensions.k8s.io/v1/ |  |
...
> <V1CustomResourceDefinition> create_custom_resource_definition(body, opts)
...
api_instance = Kubernetes::ApiextensionsV1Api.new
body = Kubernetes::V1CustomResourceDefinition.new({spec: Kubernetes::V1CustomResourceDefinitionSpec.new({group: 'group_example', names: Kubernetes::V1CustomResourceDefinitionNames.new({kind: 'kind_example', plural: 'plural_example'}), scope: 'scope_example', versions: [Kubernetes::V1CustomResourceDefinitionVersion.new({name: 'name_example', served: false, storage: false})]})}) # V1CustomResourceDefinition | 
opts = {
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->create_custom_resource_definition: #{e}"
end
```

#### Using the create_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> create_custom_resource_definition_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_custom_resource_definition_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->create_custom_resource_definition_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->delete_collection_custom_resource_definition: #{e}"
end
```

#### Using the delete_collection_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_custom_resource_definition_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_custom_resource_definition_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->delete_collection_custom_resource_definition_with_http_info: #{e}"
end
```
...
> <V1Status> delete_custom_resource_definition(name, opts)
...
begin
  ...
  result = api_instance.delete_custom_resource_definition(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->delete_custom_resource_definition: #{e}"
end
```

#### Using the delete_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_custom_resource_definition_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_custom_resource_definition_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->delete_custom_resource_definition_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_apiextensions_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_apiextensions_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_apiextensions_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->get_api_resources_get_apis_apiextensions_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_apiextensions_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_apiextensions_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_apiextensions_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->get_api_resources_get_apis_apiextensions_k8s_io_v1_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinitionList> list_custom_resource_definition(opts)
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->list_custom_resource_definition: #{e}"
end
```

#### Using the list_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinitionList>, Integer, Hash)> list_custom_resource_definition_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_custom_resource_definition_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinitionList>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->list_custom_resource_definition_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> patch_custom_resource_definition(name, body, opts)
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->patch_custom_resource_definition: #{e}"
end
```

#### Using the patch_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> patch_custom_resource_definition_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_custom_resource_definition_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->patch_custom_resource_definition_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> patch_custom_resource_definition_status(name, body, opts)
...
begin
  ...
  result = api_instance.patch_custom_resource_definition_status(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->patch_custom_resource_definition_status: #{e}"
end
```

#### Using the patch_custom_resource_definition_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> patch_custom_resource_definition_status_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_custom_resource_definition_status_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->patch_custom_resource_definition_status_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> read_custom_resource_definition(name, opts)
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->read_custom_resource_definition: #{e}"
end
```

#### Using the read_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> read_custom_resource_definition_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_custom_resource_definition_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->read_custom_resource_definition_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> read_custom_resource_definition_status(name, opts)
...
begin
  ...
  result = api_instance.read_custom_resource_definition_status(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->read_custom_resource_definition_status: #{e}"
end
```

#### Using the read_custom_resource_definition_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> read_custom_resource_definition_status_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_custom_resource_definition_status_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->read_custom_resource_definition_status_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> replace_custom_resource_definition(name, body, opts)
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->replace_custom_resource_definition: #{e}"
end
```

#### Using the replace_custom_resource_definition_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> replace_custom_resource_definition_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_custom_resource_definition_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->replace_custom_resource_definition_with_http_info: #{e}"
end
```
...
> <V1CustomResourceDefinition> replace_custom_resource_definition_status(name, body, opts)
...
begin
  ...
  puts "Error when calling ApiextensionsV1Api->replace_custom_resource_definition_status: #{e}"
end
```

#### Using the replace_custom_resource_definition_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1CustomResourceDefinition>, Integer, Hash)> replace_custom_resource_definition_status_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_custom_resource_definition_status_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1CustomResourceDefinition>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiextensionsV1Api->replace_custom_resource_definition_status_with_http_info: #{e}"
end
```
