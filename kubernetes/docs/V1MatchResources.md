...
| **resource_rules** | [**Array&lt;V1NamedRuleWithOperations&gt;**](V1NamedRuleWithOperations.md) | resourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule. | [optional] |
...
instance = Kubernetes::V1MatchResources.new(
