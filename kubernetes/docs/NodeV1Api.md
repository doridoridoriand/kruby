...
| [**get_api_resources_get_apis_node_k8s_io_v1**](NodeV1Api.md#get_api_resources_get_apis_node_k8s_io_v1) | **GET** /apis/node.k8s.io/v1/ |  |
...
> <V1RuntimeClass> create_runtime_class(body, opts)
...
api_instance = Kubernetes::NodeV1Api.new
body = Kubernetes::V1RuntimeClass.new({handler: 'handler_example'}) # V1RuntimeClass | 
opts = {
...
begin
  ...
  result = api_instance.create_runtime_class(body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->create_runtime_class: #{e}"
end
```

#### Using the create_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RuntimeClass>, Integer, Hash)> create_runtime_class_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_runtime_class_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RuntimeClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->create_runtime_class_with_http_info: #{e}"
end
```
...
> <V1Status> delete_collection_runtime_class(opts)
...
begin
  ...
  result = api_instance.delete_collection_runtime_class(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->delete_collection_runtime_class: #{e}"
end
```

#### Using the delete_collection_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_runtime_class_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_runtime_class_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->delete_collection_runtime_class_with_http_info: #{e}"
end
```
...
> <V1Status> delete_runtime_class(name, opts)
...
begin
  ...
  result = api_instance.delete_runtime_class(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->delete_runtime_class: #{e}"
end
```

#### Using the delete_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_runtime_class_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_runtime_class_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->delete_runtime_class_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_node_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_node_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_node_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->get_api_resources_get_apis_node_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_node_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_node_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_node_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->get_api_resources_get_apis_node_k8s_io_v1_with_http_info: #{e}"
end
```
...
> <V1RuntimeClassList> list_runtime_class(opts)
...
begin
  ...
  result = api_instance.list_runtime_class(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->list_runtime_class: #{e}"
end
```

#### Using the list_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RuntimeClassList>, Integer, Hash)> list_runtime_class_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_runtime_class_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RuntimeClassList>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->list_runtime_class_with_http_info: #{e}"
end
```
...
> <V1RuntimeClass> patch_runtime_class(name, body, opts)
...
begin
  ...
  result = api_instance.patch_runtime_class(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->patch_runtime_class: #{e}"
end
```

#### Using the patch_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RuntimeClass>, Integer, Hash)> patch_runtime_class_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_runtime_class_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RuntimeClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->patch_runtime_class_with_http_info: #{e}"
end
```
...
> <V1RuntimeClass> read_runtime_class(name, opts)
...
begin
  ...
  result = api_instance.read_runtime_class(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->read_runtime_class: #{e}"
end
```

#### Using the read_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RuntimeClass>, Integer, Hash)> read_runtime_class_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_runtime_class_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RuntimeClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->read_runtime_class_with_http_info: #{e}"
end
```
...
> <V1RuntimeClass> replace_runtime_class(name, body, opts)
...
begin
  ...
  result = api_instance.replace_runtime_class(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->replace_runtime_class: #{e}"
end
```

#### Using the replace_runtime_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RuntimeClass>, Integer, Hash)> replace_runtime_class_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_runtime_class_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RuntimeClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling NodeV1Api->replace_runtime_class_with_http_info: #{e}"
end
```
