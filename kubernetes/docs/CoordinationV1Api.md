...
| [**get_api_resources_get_apis_coordination_k8s_io_v1**](CoordinationV1Api.md#get_api_resources_get_apis_coordination_k8s_io_v1) | **GET** /apis/coordination.k8s.io/v1/ |  |
...
> <V1Lease> create_namespaced_lease(namespace, body, opts)
...
api_instance = Kubernetes::CoordinationV1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1Lease.new # V1Lease | 
opts = {
...
begin
  ...
  result = api_instance.create_namespaced_lease(namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->create_namespaced_lease: #{e}"
end
```

#### Using the create_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Lease>, Integer, Hash)> create_namespaced_lease_with_http_info(namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_namespaced_lease_with_http_info(namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Lease>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->create_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1Api->delete_collection_namespaced_lease: #{e}"
end
```

#### Using the delete_collection_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_namespaced_lease_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_namespaced_lease_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->delete_collection_namespaced_lease_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling CoordinationV1Api->delete_namespaced_lease: #{e}"
end
```

#### Using the delete_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_namespaced_lease_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_namespaced_lease_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->delete_namespaced_lease_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_coordination_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_coordination_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_coordination_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->get_api_resources_get_apis_coordination_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_coordination_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_coordination_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_coordination_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->get_api_resources_get_apis_coordination_k8s_io_v1_with_http_info: #{e}"
end
```
...
> <V1LeaseList> list_lease_for_all_namespaces(opts)
...
begin
  ...
  puts "Error when calling CoordinationV1Api->list_lease_for_all_namespaces: #{e}"
end
```

#### Using the list_lease_for_all_namespaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1LeaseList>, Integer, Hash)> list_lease_for_all_namespaces_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_lease_for_all_namespaces_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1LeaseList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->list_lease_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1LeaseList> list_namespaced_lease(namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1Api->list_namespaced_lease: #{e}"
end
```

#### Using the list_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1LeaseList>, Integer, Hash)> list_namespaced_lease_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_namespaced_lease_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1LeaseList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->list_namespaced_lease_with_http_info: #{e}"
end
```
...
> <V1Lease> patch_namespaced_lease(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1Api->patch_namespaced_lease: #{e}"
end
```

#### Using the patch_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Lease>, Integer, Hash)> patch_namespaced_lease_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_lease_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Lease>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->patch_namespaced_lease_with_http_info: #{e}"
end
```
...
> <V1Lease> read_namespaced_lease(name, namespace, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1Api->read_namespaced_lease: #{e}"
end
```

#### Using the read_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Lease>, Integer, Hash)> read_namespaced_lease_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_lease_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Lease>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->read_namespaced_lease_with_http_info: #{e}"
end
```
...
> <V1Lease> replace_namespaced_lease(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling CoordinationV1Api->replace_namespaced_lease: #{e}"
end
```

#### Using the replace_namespaced_lease_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Lease>, Integer, Hash)> replace_namespaced_lease_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_lease_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Lease>
rescue Kubernetes::ApiError => e
  puts "Error when calling CoordinationV1Api->replace_namespaced_lease_with_http_info: #{e}"
end
```
