...
| **selectors** | [**Array&lt;V1beta2DeviceSelector&gt;**](V1beta2DeviceSelector.md) | Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this request. All selectors must be satisfied for a device to be considered. | [optional] |
...
instance = Kubernetes::V1beta2ExactDeviceRequest.new(
  admin_access: null,
