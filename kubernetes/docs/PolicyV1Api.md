...
| [**get_api_resources_get_apis_policy_v1**](PolicyV1Api.md#get_api_resources_get_apis_policy_v1) | **GET** /apis/policy/v1/ |  |
...
> <V1PodDisruptionBudget> create_namespaced_pod_disruption_budget(namespace, body, opts)
...
api_instance = Kubernetes::PolicyV1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1PodDisruptionBudget.new # V1PodDisruptionBudget | 
opts = {
...
begin
  ...
  puts "Error when calling PolicyV1Api->create_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the create_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> create_namespaced_pod_disruption_budget_with_http_info(namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_namespaced_pod_disruption_budget_with_http_info(namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->create_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PolicyV1Api->delete_collection_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the delete_collection_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_namespaced_pod_disruption_budget_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_namespaced_pod_disruption_budget_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->delete_collection_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PolicyV1Api->delete_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the delete_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->delete_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_policy_v1

> <V1APIResourceList> get_api_resources_get_apis_policy_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_policy_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->get_api_resources_get_apis_policy_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_policy_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_policy_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_policy_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->get_api_resources_get_apis_policy_v1_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudgetList> list_namespaced_pod_disruption_budget(namespace, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->list_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the list_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudgetList>, Integer, Hash)> list_namespaced_pod_disruption_budget_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_namespaced_pod_disruption_budget_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudgetList>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->list_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudgetList> list_pod_disruption_budget_for_all_namespaces(opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->list_pod_disruption_budget_for_all_namespaces: #{e}"
end
```

#### Using the list_pod_disruption_budget_for_all_namespaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudgetList>, Integer, Hash)> list_pod_disruption_budget_for_all_namespaces_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_pod_disruption_budget_for_all_namespaces_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudgetList>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->list_pod_disruption_budget_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> patch_namespaced_pod_disruption_budget(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->patch_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the patch_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> patch_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->patch_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> patch_namespaced_pod_disruption_budget_status(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->patch_namespaced_pod_disruption_budget_status: #{e}"
end
```

#### Using the patch_namespaced_pod_disruption_budget_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> patch_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->patch_namespaced_pod_disruption_budget_status_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> read_namespaced_pod_disruption_budget(name, namespace, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->read_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the read_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> read_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->read_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> read_namespaced_pod_disruption_budget_status(name, namespace, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->read_namespaced_pod_disruption_budget_status: #{e}"
end
```

#### Using the read_namespaced_pod_disruption_budget_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> read_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->read_namespaced_pod_disruption_budget_status_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> replace_namespaced_pod_disruption_budget(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->replace_namespaced_pod_disruption_budget: #{e}"
end
```

#### Using the replace_namespaced_pod_disruption_budget_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> replace_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->replace_namespaced_pod_disruption_budget_with_http_info: #{e}"
end
```
...
> <V1PodDisruptionBudget> replace_namespaced_pod_disruption_budget_status(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling PolicyV1Api->replace_namespaced_pod_disruption_budget_status: #{e}"
end
```

#### Using the replace_namespaced_pod_disruption_budget_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PodDisruptionBudget>, Integer, Hash)> replace_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PodDisruptionBudget>
rescue Kubernetes::ApiError => e
  puts "Error when calling PolicyV1Api->replace_namespaced_pod_disruption_budget_status_with_http_info: #{e}"
end
```
