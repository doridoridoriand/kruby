...
| **taints** | [**Array&lt;V1beta2DeviceTaint&gt;**](V1beta2DeviceTaint.md) | If specified, these are the driver-defined taints.  The maximum number of taints is 16. If taints are set for any device in a ResourceSlice, then the maximum number of allowed devices per ResourceSlice is 64 instead of 128.  This is a beta field and requires enabling the DRADeviceTaints feature gate. | [optional] |
...
instance = Kubernetes::V1beta2Device.new(
  all_nodes: null,
  ...
  name: null,
  node_allocatable_resource_mappings: null,
  node_name: null,
  node_selector: null,
  taints: null
)
