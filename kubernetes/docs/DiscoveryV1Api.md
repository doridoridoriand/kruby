...
| [**get_api_resources_get_apis_discovery_k8s_io_v1**](DiscoveryV1Api.md#get_api_resources_get_apis_discovery_k8s_io_v1) | **GET** /apis/discovery.k8s.io/v1/ |  |
...
> <V1EndpointSlice> create_namespaced_endpoint_slice(namespace, body, opts)
...
api_instance = Kubernetes::DiscoveryV1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1EndpointSlice.new({address_type: 'address_type_example'}) # V1EndpointSlice | 
opts = {
...
begin
  ...
  result = api_instance.create_namespaced_endpoint_slice(namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->create_namespaced_endpoint_slice: #{e}"
end
```

#### Using the create_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSlice>, Integer, Hash)> create_namespaced_endpoint_slice_with_http_info(namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_namespaced_endpoint_slice_with_http_info(namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSlice>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->create_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
> <V1Status> delete_collection_namespaced_endpoint_slice(namespace, opts)
...
begin
  ...
  result = api_instance.delete_collection_namespaced_endpoint_slice(namespace, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->delete_collection_namespaced_endpoint_slice: #{e}"
end
```

#### Using the delete_collection_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_namespaced_endpoint_slice_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_namespaced_endpoint_slice_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->delete_collection_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
> <V1Status> delete_namespaced_endpoint_slice(name, namespace, opts)
...
begin
  ...
  result = api_instance.delete_namespaced_endpoint_slice(name, namespace, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->delete_namespaced_endpoint_slice: #{e}"
end
```

#### Using the delete_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_namespaced_endpoint_slice_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_namespaced_endpoint_slice_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->delete_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_discovery_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_discovery_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_discovery_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->get_api_resources_get_apis_discovery_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_discovery_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_discovery_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_discovery_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->get_api_resources_get_apis_discovery_k8s_io_v1_with_http_info: #{e}"
end
```
...
> <V1EndpointSliceList> list_endpoint_slice_for_all_namespaces(opts)
...
begin
  ...
  result = api_instance.list_endpoint_slice_for_all_namespaces(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->list_endpoint_slice_for_all_namespaces: #{e}"
end
```

#### Using the list_endpoint_slice_for_all_namespaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSliceList>, Integer, Hash)> list_endpoint_slice_for_all_namespaces_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_endpoint_slice_for_all_namespaces_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSliceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->list_endpoint_slice_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1EndpointSliceList> list_namespaced_endpoint_slice(namespace, opts)
...
begin
  ...
  result = api_instance.list_namespaced_endpoint_slice(namespace, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->list_namespaced_endpoint_slice: #{e}"
end
```

#### Using the list_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSliceList>, Integer, Hash)> list_namespaced_endpoint_slice_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_namespaced_endpoint_slice_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSliceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->list_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
> <V1EndpointSlice> patch_namespaced_endpoint_slice(name, namespace, body, opts)
...
begin
  ...
  result = api_instance.patch_namespaced_endpoint_slice(name, namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->patch_namespaced_endpoint_slice: #{e}"
end
```

#### Using the patch_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSlice>, Integer, Hash)> patch_namespaced_endpoint_slice_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_endpoint_slice_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSlice>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->patch_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
> <V1EndpointSlice> read_namespaced_endpoint_slice(name, namespace, opts)
...
begin
  ...
  result = api_instance.read_namespaced_endpoint_slice(name, namespace, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->read_namespaced_endpoint_slice: #{e}"
end
```

#### Using the read_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSlice>, Integer, Hash)> read_namespaced_endpoint_slice_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_endpoint_slice_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSlice>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->read_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
...
> <V1EndpointSlice> replace_namespaced_endpoint_slice(name, namespace, body, opts)
...
begin
  ...
  result = api_instance.replace_namespaced_endpoint_slice(name, namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->replace_namespaced_endpoint_slice: #{e}"
end
```

#### Using the replace_namespaced_endpoint_slice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1EndpointSlice>, Integer, Hash)> replace_namespaced_endpoint_slice_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_endpoint_slice_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1EndpointSlice>
rescue Kubernetes::ApiError => e
  puts "Error when calling DiscoveryV1Api->replace_namespaced_endpoint_slice_with_http_info: #{e}"
end
```
