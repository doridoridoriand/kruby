# Kubernetes::CertificatesV1alpha1Api
...
| [**get_api_resources_get_apis_certificates_k8s_io_v1alpha1**](CertificatesV1alpha1Api.md#get_api_resources_get_apis_certificates_k8s_io_v1alpha1) | **GET** /apis/certificates.k8s.io/v1alpha1/ |  |
...
api_instance = Kubernetes::CertificatesV1alpha1Api.new
body = Kubernetes::V1alpha1ClusterTrustBundle.new({spec: Kubernetes::V1alpha1ClusterTrustBundleSpec.new({trust_bundle: 'trust_bundle_example'})}) # V1alpha1ClusterTrustBundle | 
opts = {
...
## get_api_resources_get_apis_certificates_k8s_io_v1alpha1

> <V1APIResourceList> get_api_resources_get_apis_certificates_k8s_io_v1alpha1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_certificates_k8s_io_v1alpha1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling CertificatesV1alpha1Api->get_api_resources_get_apis_certificates_k8s_io_v1alpha1: #{e}"
end
```

#### Using the get_api_resources_get_apis_certificates_k8s_io_v1alpha1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_certificates_k8s_io_v1alpha1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_certificates_k8s_io_v1alpha1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CertificatesV1alpha1Api->get_api_resources_get_apis_certificates_k8s_io_v1alpha1_with_http_info: #{e}"
end
```
