...
| [**get_api_resources_get_apis_by_group_by_version**](CustomObjectsApi.md#get_api_resources_get_apis_by_group_by_version) | **GET** /apis/{group}/{version} |  |
...
## get_api_resources_get_apis_by_group_by_version

> <V1APIResourceList> get_api_resources_get_apis_by_group_by_version(group, version)
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_by_group_by_version(group, version)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling CustomObjectsApi->get_api_resources_get_apis_by_group_by_version: #{e}"
end
```

#### Using the get_api_resources_get_apis_by_group_by_version_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_by_group_by_version_with_http_info(group, version)

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_by_group_by_version_with_http_info(group, version)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling CustomObjectsApi->get_api_resources_get_apis_by_group_by_version_with_http_info: #{e}"
end
```
