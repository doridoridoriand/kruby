...
| [**get_api_resources_get_apis_scheduling_k8s_io_v1**](SchedulingV1Api.md#get_api_resources_get_apis_scheduling_k8s_io_v1) | **GET** /apis/scheduling.k8s.io/v1/ |  |
...
begin
  ...
  puts "Error when calling SchedulingV1Api->create_priority_class: #{e}"
end
```

#### Using the create_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PriorityClass>, Integer, Hash)> create_priority_class_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_priority_class_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PriorityClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->create_priority_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->delete_collection_priority_class: #{e}"
end
```

#### Using the delete_collection_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_priority_class_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_priority_class_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->delete_collection_priority_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->delete_priority_class: #{e}"
end
```

#### Using the delete_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_priority_class_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_priority_class_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->delete_priority_class_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_scheduling_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_scheduling_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_scheduling_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->get_api_resources_get_apis_scheduling_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->list_priority_class: #{e}"
end
```

#### Using the list_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PriorityClassList>, Integer, Hash)> list_priority_class_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_priority_class_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PriorityClassList>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->list_priority_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->patch_priority_class: #{e}"
end
```

#### Using the patch_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PriorityClass>, Integer, Hash)> patch_priority_class_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_priority_class_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PriorityClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->patch_priority_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->read_priority_class: #{e}"
end
```

#### Using the read_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PriorityClass>, Integer, Hash)> read_priority_class_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_priority_class_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PriorityClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->read_priority_class_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1Api->replace_priority_class: #{e}"
end
```

#### Using the replace_priority_class_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1PriorityClass>, Integer, Hash)> replace_priority_class_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_priority_class_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1PriorityClass>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1Api->replace_priority_class_with_http_info: #{e}"
end
```
