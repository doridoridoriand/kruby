...
| [**get_api_resources_apps_v1**](AppsV1Api.md#get_api_resources_apps_v1) | **GET** /apis/apps/v1/ |  |
...
## get_api_resources_apps_v1

> <V1APIResourceList> get_api_resources_apps_v1
...
begin
  ...
  result = api_instance.get_api_resources_apps_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling AppsV1Api->get_api_resources_apps_v1: #{e}"
end
```

#### Using the get_api_resources_apps_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_apps_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_apps_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling AppsV1Api->get_api_resources_apps_v1_with_http_info: #{e}"
end
```
