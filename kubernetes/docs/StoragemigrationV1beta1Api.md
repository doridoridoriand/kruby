...
| [**get_api_resources_get_apis_storagemigration_k8s_io_v1beta1**](StoragemigrationV1beta1Api.md#get_api_resources_get_apis_storagemigration_k8s_io_v1beta1) | **GET** /apis/storagemigration.k8s.io/v1beta1/ |  |
...
## get_api_resources_get_apis_storagemigration_k8s_io_v1beta1

> <V1APIResourceList> get_api_resources_get_apis_storagemigration_k8s_io_v1beta1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_storagemigration_k8s_io_v1beta1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling StoragemigrationV1beta1Api->get_api_resources_get_apis_storagemigration_k8s_io_v1beta1: #{e}"
end
```

#### Using the get_api_resources_get_apis_storagemigration_k8s_io_v1beta1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_storagemigration_k8s_io_v1beta1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_storagemigration_k8s_io_v1beta1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling StoragemigrationV1beta1Api->get_api_resources_get_apis_storagemigration_k8s_io_v1beta1_with_http_info: #{e}"
end
```
