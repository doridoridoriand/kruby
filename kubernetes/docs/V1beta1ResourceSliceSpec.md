...
| **devices** | [**Array&lt;V1beta1Device&gt;**](V1beta1Device.md) | Devices lists some or all of the devices in this pool.  Must not have more than 128 entries. If any device uses taints or consumes counters the limit is 64.  Only one of Devices and SharedCounters can be set in a ResourceSlice. | [optional] |
...
instance = Kubernetes::V1beta1ResourceSliceSpec.new(
  all_nodes: null,
  devices: null,
  driver: null,
  node_name: null,
