...
| [**get_api_resources_scheduling_v1alpha1**](SchedulingV1alpha1Api.md#get_api_resources_scheduling_v1alpha1) | **GET** /apis/scheduling.k8s.io/v1alpha1/ |  |
...
> <V1alpha1Workload> create_namespaced_workload(namespace, body, opts)
...
api_instance = Kubernetes::SchedulingV1alpha1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1alpha1Workload.new({spec: Kubernetes::V1alpha1WorkloadSpec.new({pod_groups: [Kubernetes::V1alpha1PodGroup.new({name: 'name_example', policy: Kubernetes::V1alpha1PodGroupPolicy.new})]})}) # V1alpha1Workload | 
opts = {
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->create_namespaced_workload: #{e}"
end
```
...
> <Array(<V1alpha1Workload>, Integer, Hash)> create_namespaced_workload_with_http_info(namespace, body, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1Workload>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1alpha1Api->create_namespaced_workload_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->delete_collection_namespaced_workload: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->delete_collection_namespaced_workload_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->delete_namespaced_workload: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->delete_namespaced_workload_with_http_info: #{e}"
end
```
...
## get_api_resources_scheduling_v1alpha1

> <V1APIResourceList> get_api_resources_scheduling_v1alpha1
...
begin
  ...
  result = api_instance.get_api_resources_scheduling_v1alpha1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1alpha1Api->get_api_resources_scheduling_v1alpha1: #{e}"
end
```

#### Using the get_api_resources_scheduling_v1alpha1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_scheduling_v1alpha1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_scheduling_v1alpha1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1alpha1Api->get_api_resources_scheduling_v1alpha1_with_http_info: #{e}"
end
```
...
> <V1alpha1WorkloadList> list_namespaced_workload(namespace, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->list_namespaced_workload: #{e}"
end
```
...
> <Array(<V1alpha1WorkloadList>, Integer, Hash)> list_namespaced_workload_with_http_info(namespace, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1alpha1WorkloadList>
rescue Kubernetes::ApiError => e
  puts "Error when calling SchedulingV1alpha1Api->list_namespaced_workload_with_http_info: #{e}"
end
```
...
> <V1alpha1WorkloadList> list_workload_for_all_namespaces(opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->list_workload_for_all_namespaces: #{e}"
end
```
...
> <Array(<V1alpha1WorkloadList>, Integer, Hash)> list_workload_for_all_namespaces_with_http_info(opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->list_workload_for_all_namespaces_with_http_info: #{e}"
end
```
...
> <V1alpha1Workload> patch_namespaced_workload(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->patch_namespaced_workload: #{e}"
end
```
...
> <Array(<V1alpha1Workload>, Integer, Hash)> patch_namespaced_workload_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->patch_namespaced_workload_with_http_info: #{e}"
end
```
...
> <V1alpha1Workload> read_namespaced_workload(name, namespace, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->read_namespaced_workload: #{e}"
end
```
...
> <Array(<V1alpha1Workload>, Integer, Hash)> read_namespaced_workload_with_http_info(name, namespace, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->read_namespaced_workload_with_http_info: #{e}"
end
```
...
> <V1alpha1Workload> replace_namespaced_workload(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->replace_namespaced_workload: #{e}"
end
```
...
> <Array(<V1alpha1Workload>, Integer, Hash)> replace_namespaced_workload_with_http_info(name, namespace, body, opts)
...
begin
  ...
  puts "Error when calling SchedulingV1alpha1Api->replace_namespaced_workload_with_http_info: #{e}"
end
```
