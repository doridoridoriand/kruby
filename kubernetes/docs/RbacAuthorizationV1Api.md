...
| [**get_api_resources_get_apis_rbac_authorization_k8s_io_v1**](RbacAuthorizationV1Api.md#get_api_resources_get_apis_rbac_authorization_k8s_io_v1) | **GET** /apis/rbac.authorization.k8s.io/v1/ |  |
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->create_cluster_role: #{e}"
end
```

#### Using the create_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRole>, Integer, Hash)> create_cluster_role_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_cluster_role_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRole>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->create_cluster_role_with_http_info: #{e}"
end
```
...
api_instance = Kubernetes::RbacAuthorizationV1Api.new
body = Kubernetes::V1ClusterRoleBinding.new({role_ref: Kubernetes::V1RoleRef.new({kind: 'kind_example', name: 'name_example'})}) # V1ClusterRoleBinding | 
opts = {
  pretty: 'pretty_example', # String | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
  dry_run: 'dry_run_example', # String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  field_manager: 'field_manager_example', # String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->create_cluster_role_binding: #{e}"
end
```

#### Using the create_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleBinding>, Integer, Hash)> create_cluster_role_binding_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_cluster_role_binding_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->create_cluster_role_binding_with_http_info: #{e}"
end
```
...
> <V1Role> create_namespaced_role(namespace, body, opts)
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->create_namespaced_role: #{e}"
end
```

#### Using the create_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Role>, Integer, Hash)> create_namespaced_role_with_http_info(namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_namespaced_role_with_http_info(namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Role>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->create_namespaced_role_with_http_info: #{e}"
end
```
...
> <V1RoleBinding> create_namespaced_role_binding(namespace, body, opts)
...
api_instance = Kubernetes::RbacAuthorizationV1Api.new
namespace = 'namespace_example' # String | object name and auth scope, such as for teams and projects
body = Kubernetes::V1RoleBinding.new({role_ref: Kubernetes::V1RoleRef.new({kind: 'kind_example', name: 'name_example'})}) # V1RoleBinding | 
opts = {
  pretty: 'pretty_example', # String | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
  dry_run: 'dry_run_example', # String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  field_manager: 'field_manager_example', # String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->create_namespaced_role_binding: #{e}"
end
```

#### Using the create_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBinding>, Integer, Hash)> create_namespaced_role_binding_with_http_info(namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_namespaced_role_binding_with_http_info(namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->create_namespaced_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_cluster_role: #{e}"
end
```

#### Using the delete_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_cluster_role_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_cluster_role_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_cluster_role_binding: #{e}"
end
```

#### Using the delete_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_cluster_role_binding_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_cluster_role_binding_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_cluster_role: #{e}"
end
```

#### Using the delete_collection_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_cluster_role_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_cluster_role_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_cluster_role_binding: #{e}"
end
```

#### Using the delete_collection_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_cluster_role_binding_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_cluster_role_binding_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_namespaced_role: #{e}"
end
```

#### Using the delete_collection_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_namespaced_role_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_namespaced_role_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_namespaced_role_binding: #{e}"
end
```

#### Using the delete_collection_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_namespaced_role_binding_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_namespaced_role_binding_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_collection_namespaced_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_namespaced_role: #{e}"
end
```

#### Using the delete_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_namespaced_role_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_namespaced_role_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->delete_namespaced_role_binding: #{e}"
end
```

#### Using the delete_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_namespaced_role_binding_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_namespaced_role_binding_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->delete_namespaced_role_binding_with_http_info: #{e}"
end
```
...
> <V1APIResourceList> get_api_resources_get_apis_rbac_authorization_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_rbac_authorization_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->get_api_resources_get_apis_rbac_authorization_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_rbac_authorization_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_rbac_authorization_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_rbac_authorization_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->get_api_resources_get_apis_rbac_authorization_k8s_io_v1_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_cluster_role: #{e}"
end
```

#### Using the list_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleList>, Integer, Hash)> list_cluster_role_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_cluster_role_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_cluster_role_binding: #{e}"
end
```

#### Using the list_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleBindingList>, Integer, Hash)> list_cluster_role_binding_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_cluster_role_binding_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleBindingList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_namespaced_role: #{e}"
end
```

#### Using the list_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleList>, Integer, Hash)> list_namespaced_role_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_namespaced_role_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_namespaced_role_binding: #{e}"
end
```

#### Using the list_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBindingList>, Integer, Hash)> list_namespaced_role_binding_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_namespaced_role_binding_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBindingList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_namespaced_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_role_binding_for_all_namespaces: #{e}"
end
```

#### Using the list_role_binding_for_all_namespaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBindingList>, Integer, Hash)> list_role_binding_for_all_namespaces_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_role_binding_for_all_namespaces_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBindingList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_role_binding_for_all_namespaces_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->list_role_for_all_namespaces: #{e}"
end
```

#### Using the list_role_for_all_namespaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleList>, Integer, Hash)> list_role_for_all_namespaces_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_role_for_all_namespaces_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleList>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->list_role_for_all_namespaces_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->patch_cluster_role: #{e}"
end
```

#### Using the patch_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRole>, Integer, Hash)> patch_cluster_role_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_cluster_role_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRole>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->patch_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->patch_cluster_role_binding: #{e}"
end
```

#### Using the patch_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleBinding>, Integer, Hash)> patch_cluster_role_binding_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_cluster_role_binding_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->patch_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->patch_namespaced_role: #{e}"
end
```

#### Using the patch_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Role>, Integer, Hash)> patch_namespaced_role_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_role_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Role>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->patch_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->patch_namespaced_role_binding: #{e}"
end
```

#### Using the patch_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBinding>, Integer, Hash)> patch_namespaced_role_binding_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_namespaced_role_binding_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->patch_namespaced_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->read_cluster_role: #{e}"
end
```

#### Using the read_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRole>, Integer, Hash)> read_cluster_role_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_cluster_role_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRole>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->read_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->read_cluster_role_binding: #{e}"
end
```

#### Using the read_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleBinding>, Integer, Hash)> read_cluster_role_binding_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_cluster_role_binding_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->read_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->read_namespaced_role: #{e}"
end
```

#### Using the read_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Role>, Integer, Hash)> read_namespaced_role_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_role_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Role>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->read_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->read_namespaced_role_binding: #{e}"
end
```

#### Using the read_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBinding>, Integer, Hash)> read_namespaced_role_binding_with_http_info(name, namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_namespaced_role_binding_with_http_info(name, namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->read_namespaced_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->replace_cluster_role: #{e}"
end
```

#### Using the replace_cluster_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRole>, Integer, Hash)> replace_cluster_role_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_cluster_role_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRole>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->replace_cluster_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->replace_cluster_role_binding: #{e}"
end
```

#### Using the replace_cluster_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1ClusterRoleBinding>, Integer, Hash)> replace_cluster_role_binding_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_cluster_role_binding_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1ClusterRoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->replace_cluster_role_binding_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->replace_namespaced_role: #{e}"
end
```

#### Using the replace_namespaced_role_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Role>, Integer, Hash)> replace_namespaced_role_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_role_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Role>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->replace_namespaced_role_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RbacAuthorizationV1Api->replace_namespaced_role_binding: #{e}"
end
```

#### Using the replace_namespaced_role_binding_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1RoleBinding>, Integer, Hash)> replace_namespaced_role_binding_with_http_info(name, namespace, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_namespaced_role_binding_with_http_info(name, namespace, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1RoleBinding>
rescue Kubernetes::ApiError => e
  puts "Error when calling RbacAuthorizationV1Api->replace_namespaced_role_binding_with_http_info: #{e}"
end
```
