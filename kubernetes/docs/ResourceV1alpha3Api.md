...
| [**get_api_resources_resource_v1alpha3**](ResourceV1alpha3Api.md#get_api_resources_resource_v1alpha3) | **GET** /apis/resource.k8s.io/v1alpha3/ |  |
...
## get_api_resources_resource_v1alpha3

> <V1APIResourceList> get_api_resources_resource_v1alpha3
...
begin
  ...
  result = api_instance.get_api_resources_resource_v1alpha3
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ResourceV1alpha3Api->get_api_resources_resource_v1alpha3: #{e}"
end
```

#### Using the get_api_resources_resource_v1alpha3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_resource_v1alpha3_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_resource_v1alpha3_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling ResourceV1alpha3Api->get_api_resources_resource_v1alpha3_with_http_info: #{e}"
end
```
