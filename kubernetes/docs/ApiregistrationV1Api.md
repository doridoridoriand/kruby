...
| [**get_api_resources_get_apis_apiregistration_k8s_io_v1**](ApiregistrationV1Api.md#get_api_resources_get_apis_apiregistration_k8s_io_v1) | **GET** /apis/apiregistration.k8s.io/v1/ |  |
...
> <V1APIService> create_api_service(body, opts)
...
api_instance = Kubernetes::ApiregistrationV1Api.new
body = Kubernetes::V1APIService.new # V1APIService | 
opts = {
...
begin
  ...
  result = api_instance.create_api_service(body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->create_api_service: #{e}"
end
```

#### Using the create_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> create_api_service_with_http_info(body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.create_api_service_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->create_api_service_with_http_info: #{e}"
end
```
...
> <V1Status> delete_api_service(name, opts)
...
begin
  ...
  result = api_instance.delete_api_service(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->delete_api_service: #{e}"
end
```

#### Using the delete_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_api_service_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_api_service_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->delete_api_service_with_http_info: #{e}"
end
```
...
> <V1Status> delete_collection_api_service(opts)
...
begin
  ...
  result = api_instance.delete_collection_api_service(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->delete_collection_api_service: #{e}"
end
```

#### Using the delete_collection_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1Status>, Integer, Hash)> delete_collection_api_service_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_collection_api_service_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1Status>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->delete_collection_api_service_with_http_info: #{e}"
end
```
...
## get_api_resources_get_apis_apiregistration_k8s_io_v1

> <V1APIResourceList> get_api_resources_get_apis_apiregistration_k8s_io_v1
...
begin
  ...
  result = api_instance.get_api_resources_get_apis_apiregistration_k8s_io_v1
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->get_api_resources_get_apis_apiregistration_k8s_io_v1: #{e}"
end
```

#### Using the get_api_resources_get_apis_apiregistration_k8s_io_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIResourceList>, Integer, Hash)> get_api_resources_get_apis_apiregistration_k8s_io_v1_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_api_resources_get_apis_apiregistration_k8s_io_v1_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIResourceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->get_api_resources_get_apis_apiregistration_k8s_io_v1_with_http_info: #{e}"
end
```
...
> <V1APIServiceList> list_api_service(opts)
...
begin
  ...
  result = api_instance.list_api_service(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->list_api_service: #{e}"
end
```

#### Using the list_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIServiceList>, Integer, Hash)> list_api_service_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_api_service_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIServiceList>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->list_api_service_with_http_info: #{e}"
end
```
...
> <V1APIService> patch_api_service(name, body, opts)
...
begin
  ...
  result = api_instance.patch_api_service(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->patch_api_service: #{e}"
end
```

#### Using the patch_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> patch_api_service_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_api_service_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->patch_api_service_with_http_info: #{e}"
end
```
...
> <V1APIService> patch_api_service_status(name, body, opts)
...
begin
  ...
  result = api_instance.patch_api_service_status(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->patch_api_service_status: #{e}"
end
```

#### Using the patch_api_service_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> patch_api_service_status_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.patch_api_service_status_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->patch_api_service_status_with_http_info: #{e}"
end
```
...
> <V1APIService> read_api_service(name, opts)
...
begin
  ...
  result = api_instance.read_api_service(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->read_api_service: #{e}"
end
```

#### Using the read_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> read_api_service_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_api_service_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->read_api_service_with_http_info: #{e}"
end
```
...
> <V1APIService> read_api_service_status(name, opts)
...
begin
  ...
  result = api_instance.read_api_service_status(name, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->read_api_service_status: #{e}"
end
```

#### Using the read_api_service_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> read_api_service_status_with_http_info(name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.read_api_service_status_with_http_info(name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->read_api_service_status_with_http_info: #{e}"
end
```
...
> <V1APIService> replace_api_service(name, body, opts)
...
begin
  ...
  result = api_instance.replace_api_service(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->replace_api_service: #{e}"
end
```

#### Using the replace_api_service_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> replace_api_service_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_api_service_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->replace_api_service_with_http_info: #{e}"
end
```
...
> <V1APIService> replace_api_service_status(name, body, opts)
...
begin
  ...
  result = api_instance.replace_api_service_status(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->replace_api_service_status: #{e}"
end
```

#### Using the replace_api_service_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<V1APIService>, Integer, Hash)> replace_api_service_status_with_http_info(name, body, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.replace_api_service_status_with_http_info(name, body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <V1APIService>
rescue Kubernetes::ApiError => e
  puts "Error when calling ApiregistrationV1Api->replace_api_service_status_with_http_info: #{e}"
end
```
