...
module Kubernetes
  ...
  class V1alpha3PoolStatus
    ...
    attr_accessor :allocated_devices
    ...
    attr_accessor :resource_slice_count
    ...
    attr_accessor :unavailable_devices
    ...
    def self.openapi_types
      {
        :'allocated_devices' => :'Integer',
        :'available_devices' => :'Integer',
        :'driver' => :'String',
        :'generation' => :'Integer',
        :'node_name' => :'String',
        :'pool_name' => :'String',
        :'resource_slice_count' => :'Integer',
        :'total_devices' => :'Integer',
        :'unavailable_devices' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1alpha3PoolStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1alpha3PoolStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allocated_devices')
        self.allocated_devices = attributes[:'allocated_devices']
      end

      if attributes.key?(:'available_devices')
        self.available_devices = attributes[:'available_devices']
      end
      ...
      if attributes.key?(:'resource_slice_count')
        self.resource_slice_count = attributes[:'resource_slice_count']
      end

      if attributes.key?(:'total_devices')
        self.total_devices = attributes[:'total_devices']
      end

      if attributes.key?(:'unavailable_devices')
        self.unavailable_devices = attributes[:'unavailable_devices']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allocated_devices == o.allocated_devices &&
          available_devices == o.available_devices &&
          driver == o.driver &&
          generation == o.generation &&
          node_name == o.node_name &&
          pool_name == o.pool_name &&
          resource_slice_count == o.resource_slice_count &&
          total_devices == o.total_devices &&
          unavailable_devices == o.unavailable_devices &&
    ...
    def hash
      [allocated_devices, available_devices, driver, generation, node_name, pool_name, resource_slice_count, total_devices, unavailable_devices, validation_error].hash
    end
