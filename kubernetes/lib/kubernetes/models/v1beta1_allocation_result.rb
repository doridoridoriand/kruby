...
module Kubernetes
  ...
  class V1beta1AllocationResult
    ...
    attr_accessor :allocation_timestamp
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1beta1AllocationResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1beta1AllocationResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allocation_timestamp')
        self.allocation_timestamp = attributes[:'allocation_timestamp']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allocation_timestamp == o.allocation_timestamp &&
          devices == o.devices &&
    ...
    def hash
      [allocation_timestamp, devices, node_selector].hash
    end
