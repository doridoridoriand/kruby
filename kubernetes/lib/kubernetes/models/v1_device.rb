  ...
  class V1Device
    ...
    def self.openapi_types
      {
        ...
        :'attributes' => :'Hash<String, V1DeviceAttribute>',
        :'binding_conditions' => :'Array<String>',
        :'binding_failure_conditions' => :'Array<String>',
        :'binds_to_node' => :'Boolean',
        :'capacity' => :'Hash<String, V1DeviceCapacity>',
        :'consumes_counters' => :'Array<V1DeviceCounterConsumption>',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1Device` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1Device`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
