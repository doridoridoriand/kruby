...
module Kubernetes
  ...
  class V1alpha1MutatingAdmissionPolicySpec
    ...
    attr_accessor :reinvocation_policy
    ...
    def self.openapi_types
      {
        ...
        :'match_conditions' => :'Array<V1alpha1MatchCondition>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1alpha1MutatingAdmissionPolicySpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1alpha1MutatingAdmissionPolicySpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mutations')
        if (value = attributes[:'mutations']).is_a?(Array)
      ...
      if attributes.key?(:'reinvocation_policy')
        self.reinvocation_policy = attributes[:'reinvocation_policy']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reinvocation_policy == o.reinvocation_policy &&
    ...
    def hash
      [failure_policy, match_conditions, match_constraints, mutations, param_kind, reinvocation_policy, variables].hash
    end
