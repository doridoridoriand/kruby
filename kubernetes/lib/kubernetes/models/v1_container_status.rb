...
module Kubernetes
  ...
  class V1ContainerStatus
    ...
    def hash
      [allocated_resources, allocated_resources_status, container_id, image, image_id, last_state, name, ready, resources, restart_count, started, state, stop_signal, user, volume_mounts].hash
    end
