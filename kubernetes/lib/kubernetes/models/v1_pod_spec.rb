...
module Kubernetes
  ...
  class V1PodSpec
    ...
    attr_accessor :scheduling_group
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'scheduling_group')
        self.scheduling_group = attributes[:'scheduling_group']
      end
    ...
    def hash
      [active_deadline_seconds, affinity, automount_service_account_token, containers, dns_config, dns_policy, enable_service_links, ephemeral_containers, host_aliases, host_ipc, host_network, host_pid, host_users, hostname, hostname_override, image_pull_secrets, init_containers, node_name, node_selector, os, overhead, preemption_policy, priority, priority_class_name, readiness_gates, resource_claims, resources, restart_policy, runtime_class_name, scheduler_name, scheduling_gates, scheduling_group, security_context, service_account, service_account_name, set_hostname_as_fqdn, share_process_namespace, subdomain, termination_grace_period_seconds, tolerations, topology_spread_constraints, volumes].hash
    end
