...
module Kubernetes
  ...
  class V1CSIDriverSpec
    ...
    def hash
      [attach_required, fs_group_policy, node_allocatable_update_period_seconds, pod_info_on_mount, requires_republish, se_linux_mount, service_account_token_in_secrets, storage_capacity, token_requests, volume_lifecycle_modes].hash
    end
