...
module Kubernetes
  ...
  class V1CSIDriverSpec
    ...
    attr_accessor :node_allocatable_update_period_seconds
    ...
    attr_accessor :prevent_pod_scheduling_if_missing
    ...
    attr_accessor :service_account_token_in_secrets
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'service_account_token_in_secrets')
        self.service_account_token_in_secrets = attributes[:'service_account_token_in_secrets']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_account_token_in_secrets == o.service_account_token_in_secrets &&
    ...
    def hash
      [attach_required, fs_group_policy, node_allocatable_update_period_seconds, pod_info_on_mount, prevent_pod_scheduling_if_missing, requires_republish, se_linux_mount, service_account_token_in_secrets, storage_capacity, token_requests, volume_lifecycle_modes].hash
    end
