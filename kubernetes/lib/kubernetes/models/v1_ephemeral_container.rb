...
module Kubernetes
  ...
  class V1EphemeralContainer
    ...
    attr_accessor :restart_policy_rules
    ...
    def self.openapi_types
      {
        ...
        :'resize_policy' => :'Array<V1ContainerResizePolicy>',
        :'resources' => :'V1ResourceRequirements',
        :'restart_policy' => :'String',
        :'restart_policy_rules' => :'Array<V1ContainerRestartRule>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1EphemeralContainer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1EphemeralContainer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'resize_policy')
        if (value = attributes[:'resize_policy']).is_a?(Array)
      ...
      if attributes.key?(:'restart_policy_rules')
        if (value = attributes[:'restart_policy_rules']).is_a?(Array)
          self.restart_policy_rules = value
        end
      end
      ...
      if attributes.key?(:'startup_probe')
        self.startup_probe = attributes[:'startup_probe']
      end
      ...
      if attributes.key?(:'target_container_name')
        self.target_container_name = attributes[:'target_container_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          restart_policy_rules == o.restart_policy_rules &&
          security_context == o.security_context &&
          startup_probe == o.startup_probe &&
          stdin == o.stdin &&
          stdin_once == o.stdin_once &&
          target_container_name == o.target_container_name &&
    ...
    def hash
      [args, command, env, env_from, image, image_pull_policy, lifecycle, liveness_probe, name, ports, readiness_probe, resize_policy, resources, restart_policy, restart_policy_rules, security_context, startup_probe, stdin, stdin_once, target_container_name, termination_message_path, termination_message_policy, tty, volume_devices, volume_mounts, working_dir].hash
    end
