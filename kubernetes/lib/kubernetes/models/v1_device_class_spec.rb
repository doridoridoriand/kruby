...
module Kubernetes
  ...
  class V1DeviceClassSpec
    ...
    attr_accessor :extended_resource_name
    ...
    def self.openapi_types
      {
        :'config' => :'Array<V1DeviceClassConfiguration>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1DeviceClassSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1DeviceClassSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'extended_resource_name')
        self.extended_resource_name = attributes[:'extended_resource_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          config == o.config &&
          extended_resource_name == o.extended_resource_name &&
    ...
    def hash
      [config, extended_resource_name, selectors].hash
    end
