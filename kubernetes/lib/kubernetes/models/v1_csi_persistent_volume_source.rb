...
module Kubernetes
  ...
  class V1CSIPersistentVolumeSource
    attr_accessor :controller_expand_secret_ref
    ...
    attr_accessor :node_expand_secret_ref
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'node_expand_secret_ref')
        self.node_expand_secret_ref = attributes[:'node_expand_secret_ref']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          controller_expand_secret_ref == o.controller_expand_secret_ref &&
          controller_publish_secret_ref == o.controller_publish_secret_ref &&
          driver == o.driver &&
          fs_type == o.fs_type &&
          node_expand_secret_ref == o.node_expand_secret_ref &&
    ...
    def hash
      [controller_expand_secret_ref, controller_publish_secret_ref, driver, fs_type, node_expand_secret_ref, node_publish_secret_ref, node_stage_secret_ref, read_only, volume_attributes, volume_handle].hash
    end
