...
module Kubernetes
  ...
  class V1PodStatus
    ...
    attr_accessor :extended_resource_claim_status
    ...
    def hash
      [allocated_resources, conditions, container_statuses, ephemeral_container_statuses, extended_resource_claim_status, host_ip, host_ips, init_container_statuses, message, nominated_node_name, observed_generation, phase, pod_ip, pod_ips, qos_class, reason, resize, resource_claim_statuses, resources, start_time].hash
    end
