...
module Kubernetes
  ...
  class V1beta2Device
    ...
    attr_accessor :node_allocatable_resource_mappings
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'node_allocatable_resource_mappings')
        if (value = attributes[:'node_allocatable_resource_mappings']).is_a?(Hash)
          self.node_allocatable_resource_mappings = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          node_allocatable_resource_mappings == o.node_allocatable_resource_mappings &&
    ...
    def hash
      [all_nodes, allow_multiple_allocations, attributes, binding_conditions, binding_failure_conditions, binds_to_node, capacity, consumes_counters, name, node_allocatable_resource_mappings, node_name, node_selector, taints].hash
    end
