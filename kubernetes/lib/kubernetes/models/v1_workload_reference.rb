...
module Kubernetes
  ...
  class V1WorkloadReference
    ...
    attr_accessor :pod_group_replica_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1WorkloadReference` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1WorkloadReference`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pod_group')
        self.pod_group = attributes[:'pod_group']
      end

      if attributes.key?(:'pod_group_replica_key')
        self.pod_group_replica_key = attributes[:'pod_group_replica_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @pod_group.nil?
        invalid_properties.push('invalid value for "pod_group", pod_group cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          pod_group == o.pod_group &&
          pod_group_replica_key == o.pod_group_replica_key
    end
    ...
    def hash
      [name, pod_group, pod_group_replica_key].hash
    end
