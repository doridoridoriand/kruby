  ...
  class V2HorizontalPodAutoscalerStatus
    ...
    def self.openapi_types
      {
        ...
        :'current_metrics' => :'Array<V2MetricStatus>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V2HorizontalPodAutoscalerStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V2HorizontalPodAutoscalerStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'current_metrics')
        if (value = attributes[:'current_metrics']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_metrics == o.current_metrics &&
    ...
    def hash
      [conditions, current_metrics, current_replicas, desired_replicas, last_scale_time, observed_generation].hash
    end
