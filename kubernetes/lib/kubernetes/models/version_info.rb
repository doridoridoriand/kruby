...
module Kubernetes
  ...
  class VersionInfo
    ...
    attr_accessor :emulation_major

    # EmulationMinor is the minor version of the emulation version
    attr_accessor :emulation_minor
    ...
    attr_accessor :min_compatibility_major

    # MinCompatibilityMinor is the minor version of the minimum compatibility version
    attr_accessor :min_compatibility_minor
    ...
    def self.openapi_types
      {
        :'build_date' => :'String',
        :'compiler' => :'String',
        :'emulation_major' => :'String',
        :'emulation_minor' => :'String',
        :'git_commit' => :'String',
        :'git_tree_state' => :'String',
        :'git_version' => :'String',
        :'go_version' => :'String',
        :'major' => :'String',
        :'min_compatibility_major' => :'String',
        :'min_compatibility_minor' => :'String',
        :'minor' => :'String',
        :'platform' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'emulation_major')
        self.emulation_major = attributes[:'emulation_major']
      end

      if attributes.key?(:'emulation_minor')
        self.emulation_minor = attributes[:'emulation_minor']
      end
      ...
      if attributes.key?(:'min_compatibility_major')
        self.min_compatibility_major = attributes[:'min_compatibility_major']
      end

      if attributes.key?(:'min_compatibility_minor')
        self.min_compatibility_minor = attributes[:'min_compatibility_minor']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          compiler == o.compiler &&
          emulation_major == o.emulation_major &&
          emulation_minor == o.emulation_minor &&
          git_commit == o.git_commit &&
          git_tree_state == o.git_tree_state &&
          git_version == o.git_version &&
          go_version == o.go_version &&
          major == o.major &&
          min_compatibility_major == o.min_compatibility_major &&
          min_compatibility_minor == o.min_compatibility_minor &&
          minor == o.minor &&
          platform == o.platform
    end
    ...
    def hash
      [build_date, compiler, emulation_major, emulation_minor, git_commit, git_tree_state, git_version, go_version, major, min_compatibility_major, min_compatibility_minor, minor, platform].hash
    end
