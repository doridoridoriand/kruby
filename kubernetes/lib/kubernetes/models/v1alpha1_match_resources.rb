...
module Kubernetes
  ...
  class V1alpha1MatchResources
    ...
    def self.openapi_types
      {
        :'exclude_resource_rules' => :'Array<V1alpha1NamedRuleWithOperations>',
        :'match_policy' => :'String',
        :'namespace_selector' => :'V1LabelSelector',
        :'object_selector' => :'V1LabelSelector',
        :'resource_rules' => :'Array<V1alpha1NamedRuleWithOperations>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1alpha1MatchResources` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1alpha1MatchResources`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
