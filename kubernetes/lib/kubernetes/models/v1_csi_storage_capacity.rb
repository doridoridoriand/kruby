  ...
  class V1CSIStorageCapacity
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1CSIStorageCapacity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1CSIStorageCapacity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maximum_volume_size')
        self.maximum_volume_size = attributes[:'maximum_volume_size']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          capacity == o.capacity &&
          kind == o.kind &&
          maximum_volume_size == o.maximum_volume_size &&
          metadata == o.metadata &&
