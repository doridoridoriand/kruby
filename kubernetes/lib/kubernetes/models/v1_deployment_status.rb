...
module Kubernetes
  ...
  class V1DeploymentStatus
    ...
    attr_accessor :terminating_replicas
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1DeploymentStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1DeploymentStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'terminating_replicas')
        self.terminating_replicas = attributes[:'terminating_replicas']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          replicas == o.replicas &&
          terminating_replicas == o.terminating_replicas &&
    ...
    def hash
      [available_replicas, collision_count, conditions, observed_generation, ready_replicas, replicas, terminating_replicas, unavailable_replicas, updated_replicas].hash
    end
