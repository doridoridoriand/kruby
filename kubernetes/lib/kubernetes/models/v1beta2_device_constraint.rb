...
module Kubernetes
  ...
  class V1beta2DeviceConstraint
    ...
    attr_accessor :distinct_attribute
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1beta2DeviceConstraint` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1beta2DeviceConstraint`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'distinct_attribute')
        self.distinct_attribute = attributes[:'distinct_attribute']
      end

      if attributes.key?(:'match_attribute')
        self.match_attribute = attributes[:'match_attribute']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          distinct_attribute == o.distinct_attribute &&
          match_attribute == o.match_attribute &&
          requests == o.requests
    end
    ...
    def hash
      [distinct_attribute, match_attribute, requests].hash
    end
