...
module Kubernetes
  ...
  class V1ServiceSpec
    ...
    attr_accessor :traffic_distribution
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'cluster_ips')
        if (value = attributes[:'cluster_ips']).is_a?(Array)
          self.cluster_ips = value
        end
      end

      if attributes.key?(:'external_ips')
        if (value = attributes[:'external_ips']).is_a?(Array)
      ...
      if attributes.key?(:'internal_traffic_policy')
        self.internal_traffic_policy = attributes[:'internal_traffic_policy']
      end

      if attributes.key?(:'ip_families')
        if (value = attributes[:'ip_families']).is_a?(Array)
          self.ip_families = value
        end
      end

      if attributes.key?(:'ip_family_policy')
        self.ip_family_policy = attributes[:'ip_family_policy']
      end

      if attributes.key?(:'load_balancer_class')
        self.load_balancer_class = attributes[:'load_balancer_class']
      end
      ...
      if attributes.key?(:'traffic_distribution')
        self.traffic_distribution = attributes[:'traffic_distribution']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allocate_load_balancer_node_ports == o.allocate_load_balancer_node_ports &&
          cluster_ip == o.cluster_ip &&
          cluster_ips == o.cluster_ips &&
          external_ips == o.external_ips &&
          ...
          internal_traffic_policy == o.internal_traffic_policy &&
          ip_families == o.ip_families &&
          ip_family_policy == o.ip_family_policy &&
          load_balancer_class == o.load_balancer_class &&
          ...
          traffic_distribution == o.traffic_distribution &&
          type == o.type
    end
