  ...
  class V1HorizontalPodAutoscalerSpec
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kubernetes::V1HorizontalPodAutoscalerSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kubernetes::V1HorizontalPodAutoscalerSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'target_cpu_utilization_percentage')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_cpu_utilization_percentage == o.target_cpu_utilization_percentage
    end
