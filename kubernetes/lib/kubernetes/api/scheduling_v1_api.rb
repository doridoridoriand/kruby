...
module Kubernetes
  class SchedulingV1Api
    ...
    def create_priority_class(body, opts = {})
      data, _status_code, _headers = create_priority_class_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(V1PriorityClass, Integer, Hash)>] V1PriorityClass data, response status code and response headers
    def create_priority_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.create_priority_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SchedulingV1Api.create_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1PriorityClass'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SchedulingV1Api.create_priority_class",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#create_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [V1Status]
    def delete_collection_priority_class(opts = {})
      data, _status_code, _headers = delete_collection_priority_class_with_http_info(opts)
      data
    end
    ...
    def delete_collection_priority_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.delete_collection_priority_class ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses'
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.delete_collection_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#delete_collection_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # delete a PriorityClass
    # @param name [String] name of the PriorityClass
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [Integer] :grace_period_seconds The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [V1Status]
    def delete_priority_class(name, opts = {})
      data, _status_code, _headers = delete_priority_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [Array<(V1Status, Integer, Hash)>] V1Status data, response status code and response headers
    def delete_priority_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.delete_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1Api.delete_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.delete_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#delete_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_get_apis_scheduling_k8s_io_v1(opts = {})
      data, _status_code, _headers = get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info(opts)
      data
    end
    ...
    def get_api_resources_get_apis_scheduling_k8s_io_v1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.get_api_resources_get_apis_scheduling_k8s_io_v1 ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/'
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.get_api_resources_get_apis_scheduling_k8s_io_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#get_api_resources_get_apis_scheduling_k8s_io_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_priority_class(opts = {})
      data, _status_code, _headers = list_priority_class_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1PriorityClassList, Integer, Hash)>] V1PriorityClassList data, response status code and response headers
    def list_priority_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.list_priority_class ...'
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1PriorityClassList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"SchedulingV1Api.list_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#list_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1PriorityClass]
    def patch_priority_class(name, body, opts = {})
      data, _status_code, _headers = patch_priority_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    # @return [Array<(V1PriorityClass, Integer, Hash)>] V1PriorityClass data, response status code and response headers
    def patch_priority_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.patch_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1Api.patch_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SchedulingV1Api.patch_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.patch_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#patch_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
    # @return [V1PriorityClass]
    def read_priority_class(name, opts = {})
      data, _status_code, _headers = read_priority_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
    # @return [Array<(V1PriorityClass, Integer, Hash)>] V1PriorityClass data, response status code and response headers
    def read_priority_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.read_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1Api.read_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.read_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#read_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [V1PriorityClass]
    def replace_priority_class(name, body, opts = {})
      data, _status_code, _headers = replace_priority_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(V1PriorityClass, Integer, Hash)>] V1PriorityClass data, response status code and response headers
    def replace_priority_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SchedulingV1Api.replace_priority_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SchedulingV1Api.replace_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SchedulingV1Api.replace_priority_class"
      end
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SchedulingV1Api.replace_priority_class",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SchedulingV1Api#replace_priority_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
