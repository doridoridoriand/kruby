...
module Kubernetes
  class StorageV1beta1Api
    ...
    def create_volume_attributes_class_storage_v1beta1(body, opts = {})
      data, _status_code, _headers = create_volume_attributes_class_storage_v1beta1_with_http_info(body, opts)
      data
    end
    ...
    def create_volume_attributes_class_storage_v1beta1_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.create_volume_attributes_class_storage_v1beta1 ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.create_volume_attributes_class_storage_v1beta1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.create_volume_attributes_class_storage_v1beta1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#create_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [V1Status]
    def delete_collection_volume_attributes_class_storage_v1beta1(opts = {})
      data, _status_code, _headers = delete_collection_volume_attributes_class_storage_v1beta1_with_http_info(opts)
      data
    end
    ...
    def delete_collection_volume_attributes_class_storage_v1beta1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_collection_volume_attributes_class_storage_v1beta1 ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses'
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.delete_collection_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_collection_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [V1beta1VolumeAttributesClass]
    def delete_volume_attributes_class_storage_v1beta1(name, opts = {})
      data, _status_code, _headers = delete_volume_attributes_class_storage_v1beta1_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [V1DeleteOptions] :body 
    # @return [Array<(V1beta1VolumeAttributesClass, Integer, Hash)>] V1beta1VolumeAttributesClass data, response status code and response headers
    def delete_volume_attributes_class_storage_v1beta1_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_volume_attributes_class_storage_v1beta1 ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.delete_volume_attributes_class_storage_v1beta1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.delete_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_storage_v1beta1(opts = {})
      data, _status_code, _headers = get_api_resources_storage_v1beta1_with_http_info(opts)
      data
    end
    ...
    def get_api_resources_storage_v1beta1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.get_api_resources_storage_v1beta1 ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.get_api_resources_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#get_api_resources_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_volume_attributes_class_storage_v1beta1(opts = {})
      data, _status_code, _headers = list_volume_attributes_class_storage_v1beta1_with_http_info(opts)
      data
    end
    ...
    def list_volume_attributes_class_storage_v1beta1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.list_volume_attributes_class_storage_v1beta1 ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses'
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.list_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#list_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [V1beta1VolumeAttributesClass]
    def patch_volume_attributes_class_storage_v1beta1(name, body, opts = {})
      data, _status_code, _headers = patch_volume_attributes_class_storage_v1beta1_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    # @return [Array<(V1beta1VolumeAttributesClass, Integer, Hash)>] V1beta1VolumeAttributesClass data, response status code and response headers
    def patch_volume_attributes_class_storage_v1beta1_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.patch_volume_attributes_class_storage_v1beta1 ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.patch_volume_attributes_class_storage_v1beta1"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.patch_volume_attributes_class_storage_v1beta1"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.patch_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#patch_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
    # @return [V1beta1VolumeAttributesClass]
    def read_volume_attributes_class_storage_v1beta1(name, opts = {})
      data, _status_code, _headers = read_volume_attributes_class_storage_v1beta1_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
    # @return [Array<(V1beta1VolumeAttributesClass, Integer, Hash)>] V1beta1VolumeAttributesClass data, response status code and response headers
    def read_volume_attributes_class_storage_v1beta1_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.read_volume_attributes_class_storage_v1beta1 ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.read_volume_attributes_class_storage_v1beta1"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.read_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#read_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [V1beta1VolumeAttributesClass]
    def replace_volume_attributes_class_storage_v1beta1(name, body, opts = {})
      data, _status_code, _headers = replace_volume_attributes_class_storage_v1beta1_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(V1beta1VolumeAttributesClass, Integer, Hash)>] V1beta1VolumeAttributesClass data, response status code and response headers
    def replace_volume_attributes_class_storage_v1beta1_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.replace_volume_attributes_class_storage_v1beta1 ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.replace_volume_attributes_class_storage_v1beta1"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.replace_volume_attributes_class_storage_v1beta1"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StorageV1beta1Api.replace_volume_attributes_class_storage_v1beta1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#replace_volume_attributes_class_storage_v1beta1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
