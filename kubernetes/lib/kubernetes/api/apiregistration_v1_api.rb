...
module Kubernetes
  class ApiregistrationV1Api
    ...
    def get_api_resources_apiregistration_v1(opts = {})
      data, _status_code, _headers = get_api_resources_apiregistration_v1_with_http_info(opts)
      data
    end
    ...
    def get_api_resources_apiregistration_v1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ApiregistrationV1Api.get_api_resources_apiregistration_v1 ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ApiregistrationV1Api.get_api_resources_apiregistration_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ApiregistrationV1Api#get_api_resources_apiregistration_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
