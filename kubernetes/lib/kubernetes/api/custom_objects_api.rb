...
module Kubernetes
  class CustomObjectsApi
    ...
    def get_api_resources_get_apis_by_group_by_version(group, version, opts = {})
      data, _status_code, _headers = get_api_resources_get_apis_by_group_by_version_with_http_info(group, version, opts)
      data
    end
    ...
    def get_api_resources_get_apis_by_group_by_version_with_http_info(group, version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomObjectsApi.get_api_resources_get_apis_by_group_by_version ...'
      end
      # verify the required parameter 'group' is set
      if @api_client.config.client_side_validation && group.nil?
        fail ArgumentError, "Missing the required parameter 'group' when calling CustomObjectsApi.get_api_resources_get_apis_by_group_by_version"
      end
      # verify the required parameter 'version' is set
      if @api_client.config.client_side_validation && version.nil?
        fail ArgumentError, "Missing the required parameter 'version' when calling CustomObjectsApi.get_api_resources_get_apis_by_group_by_version"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CustomObjectsApi.get_api_resources_get_apis_by_group_by_version",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomObjectsApi#get_api_resources_get_apis_by_group_by_version\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications.
    # @return [Object]
    def list_custom_object_for_all_namespaces(group, version, plural, opts = {})
      data, _status_code, _headers = list_custom_object_for_all_namespaces_with_http_info(group, version, plural, opts)
      data
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications.
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def list_custom_object_for_all_namespaces_with_http_info(group, version, plural, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'plural' is set
      if @api_client.config.client_side_validation && plural.nil?
        fail ArgumentError, "Missing the required parameter 'plural' when calling CustomObjectsApi.list_custom_object_for_all_namespaces"
      end
      # resource path
      local_var_path = '/apis/{group}/{version}/{plural}#‎'.sub('{' + 'group' + '}', CGI.escape(group.to_s)).sub('{' + 'version' + '}', CGI.escape(version.to_s)).sub('{' + 'plural' + '}', CGI.escape(plural.to_s))
