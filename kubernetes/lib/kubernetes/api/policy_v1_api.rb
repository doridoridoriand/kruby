...
module Kubernetes
  class PolicyV1Api
    ...
    # @param body [V1PodDisruptionBudget] 
    ...
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(V1PodDisruptionBudget, Integer, Hash)>] V1PodDisruptionBudget data, response status code and response headers
    def create_namespaced_pod_disruption_budget_with_http_info(namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.create_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.create_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PolicyV1Api.create_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1PodDisruptionBudget'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1Api.create_namespaced_pod_disruption_budget",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#create_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_collection_namespaced_pod_disruption_budget_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.delete_collection_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.delete_collection_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.delete_collection_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#delete_collection_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.delete_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.delete_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.delete_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.delete_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#delete_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_get_apis_policy_v1(opts = {})
      data, _status_code, _headers = get_api_resources_get_apis_policy_v1_with_http_info(opts)
      data
    end
    ...
    def get_api_resources_get_apis_policy_v1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.get_api_resources_get_apis_policy_v1 ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.get_api_resources_get_apis_policy_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#get_api_resources_get_apis_policy_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1PodDisruptionBudgetList, Integer, Hash)>] V1PodDisruptionBudgetList data, response status code and response headers
    def list_namespaced_pod_disruption_budget_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.list_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.list_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'V1PodDisruptionBudgetList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"PolicyV1Api.list_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#list_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_pod_disruption_budget_for_all_namespaces_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.list_pod_disruption_budget_for_all_namespaces ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.list_pod_disruption_budget_for_all_namespaces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#list_pod_disruption_budget_for_all_namespaces\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.patch_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.patch_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#patch_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.patch_namespaced_pod_disruption_budget_status ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget_status"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PolicyV1Api.patch_namespaced_pod_disruption_budget_status"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.patch_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#patch_namespaced_pod_disruption_budget_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.read_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.read_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.read_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.read_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#read_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.read_namespaced_pod_disruption_budget_status ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.read_namespaced_pod_disruption_budget_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.read_namespaced_pod_disruption_budget_status"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.read_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#read_namespaced_pod_disruption_budget_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_namespaced_pod_disruption_budget_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.replace_namespaced_pod_disruption_budget ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.replace_namespaced_pod_disruption_budget",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#replace_namespaced_pod_disruption_budget\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyV1Api.replace_namespaced_pod_disruption_budget_status ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget_status"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PolicyV1Api.replace_namespaced_pod_disruption_budget_status"
      end
      # resource path
      local_var_path = '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s)).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PolicyV1Api.replace_namespaced_pod_disruption_budget_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyV1Api#replace_namespaced_pod_disruption_budget_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
