...
module Kubernetes
  class VersionApi
    ...
    # get the version information for this server
    # @param [Hash] opts the optional parameters
    # @return [Array<(VersionInfo, Integer, Hash)>] VersionInfo data, response status code and response headers
    def get_code_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VersionInfo'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        :operation => :"VersionApi.get_code",
