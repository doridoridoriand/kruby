...
require_relative "../support/e2e/targets/networking_v1_network_policy"

RSpec.describe "E2E - networking.k8s.io/v1/network_policies" do
  include SpecSupport::E2E::SpecRunner

  E2E_TARGET_GROUP_ID = "networking_v1_network_policy"

  describe "network_policy" do
    let(:api_group) { "networking.k8s.io" }
    let(:version) { "v1" }
    let(:resource) { "network_policies" }
