...
require_relative "../support/e2e/targets/networking_v1_ingress"

RSpec.describe "E2E - networking.k8s.io/v1/ingresses" do
  include SpecSupport::E2E::SpecRunner

  E2E_TARGET_GROUP_ID = "networking_v1_ingress"

  describe "ingress" do
    let(:api_group) { "networking.k8s.io" }
    let(:version) { "v1" }
    let(:resource) { "ingresses" }
